...
echo 1 >  /sys/module/vic/parameters/timestamp_en

mjpg_streamer -i "/usr/lib/mjpg-streamer/input_syncframes.so -r 640x480 -camera_device0 /dev/video4 -camera_device1 /dev/video8" -o "/usr/lib/mjpg-streamer/output_http.so -w /usr/share/mjpg-streamer/www"
